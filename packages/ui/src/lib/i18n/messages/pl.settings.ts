export const settingsDict = {
  ...
  'settings.openchamber.visual.section.chatMessageWidth': 'Szerokość wiadomości',
  'settings.openchamber.visual.section.chatMessageWidthAria': 'Szerokość wiadomości',
  'settings.openchamber.visual.field.chatMessageWidthAria': 'Szerokość wiadomości: {option}',
  'settings.openchamber.visual.option.chatMessageWidth.narrow.label': 'Wąska',
  'settings.openchamber.visual.option.chatMessageWidth.wide.label': 'Szeroka',
  'settings.openchamber.visual.option.chatMessageWidth.fluid.label': 'Pełna szerokość',
