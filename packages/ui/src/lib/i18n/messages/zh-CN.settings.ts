...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.visual.section.chatMessageWidth': '消息宽度',
  'settings.openchamber.visual.section.chatMessageWidthAria': '消息宽度',
  'settings.openchamber.visual.field.chatMessageWidthAria': '消息宽度：{option}',
  'settings.openchamber.visual.option.chatMessageWidth.narrow.label': '窄',
  'settings.openchamber.visual.option.chatMessageWidth.wide.label': '宽',
  'settings.openchamber.visual.option.chatMessageWidth.fluid.label': '全宽',
