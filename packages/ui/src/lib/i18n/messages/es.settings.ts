...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.visual.section.chatMessageWidth": "Ancho de mensajes",
  "settings.openchamber.visual.section.chatMessageWidthAria": "Ancho de mensajes",
  "settings.openchamber.visual.field.chatMessageWidthAria": "Ancho de mensajes: {option}",
  "settings.openchamber.visual.option.chatMessageWidth.narrow.label": "Estrecho",
  "settings.openchamber.visual.option.chatMessageWidth.wide.label": "Ancho",
  "settings.openchamber.visual.option.chatMessageWidth.fluid.label": "Ancho completo",
